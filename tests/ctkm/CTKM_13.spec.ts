...
test.describe("Kiểm tra chức năng Tạo CTKM", () => {
  ...
  test("CTKM_13: Lưu CTKM khi ngày kết thúc trước ngày bắt đầu", async ({
    page,
  }) => {
    ...
    // Điền các thông tin hợp lệ khác để focus vào lỗi thời gian
    await page
    ...
    // 5. Nhập ngày kết thúc: 10/06/2026 (trước ngày bắt đầu)
    await page.locator("#endTime").fill("10/06/2026");
    await page.keyboard.press("Enter");
