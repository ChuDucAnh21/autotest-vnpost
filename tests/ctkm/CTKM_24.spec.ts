...
test.describe("Kiểm tra chức năng Tạo CTKM", () => {
  ...
  test("CTKM_24: Khai báo giảm giá bán theo sản phẩm trong danh mục sản phẩm", async ({
    page,
  }) => {
    ...
    const ctkmName = `CTKM_CategoryProduct_${Date.now()}`;
    ...
    // Mặc định nth(4) là "Danh mục sản phẩm", click TreeSelect nth(5) để chọn danh mục
